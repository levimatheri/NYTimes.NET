...
namespace NYTimes.NET.Clients
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.nytimes.com/svc/archive/v1";
        ...
        public string GetServerUrl(int index, Dictionary<string, string> inputVariables = null)
        {
        ...
        {
            var report = "C# SDK (NYTimes.NET) Debug Report:\n";
