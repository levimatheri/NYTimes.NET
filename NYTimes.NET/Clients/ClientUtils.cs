    ...
    public static class ClientUtils
    {
        ...
        public static string ParameterToString(object obj, IReadableConfiguration configuration = null)
        {
            return obj switch
            {
                ...
                // https://msdn.microsoft.com/en-us/library/az4se3k1(v=vs.110).aspx#Anchor_8
                // For example: 2009-06-15T13:45:30.0000000
                DateTimeOffset dateTimeOffset => dateTimeOffset.ToString((configuration ?? GlobalConfiguration.Instance)
                    .DateTimeFormat),
                bool boolean => boolean ? "true" : "false",
                ICollection collection => string.Join(",", collection.Cast<object>()),
        ...
        public static string SelectHeaderAccept(string[] accepts)
        {
            ...
            return accepts.Contains("application/json", StringComparer.OrdinalIgnoreCase) 
                ? "application/json" : string.Join(",", accepts);
        }
